...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        Activity.objects.create(user='Iron Man', activity_type='run', duration=30, date='2026-03-01')
        Activity.objects.create(user='Captain America', activity_type='cycle', duration=45, date='2026-03-02')
        Activity.objects.create(user='Thor', activity_type='swim', duration=60, date='2026-03-03')
        Activity.objects.create(user='Superman', activity_type='fly', duration=120, date='2026-03-01')
        Activity.objects.create(user='Batman', activity_type='train', duration=90, date='2026-03-02')
        Activity.objects.create(user='Wonder Woman', activity_type='fight', duration=75, date='2026-03-03')

        # Create leaderboard
        Leaderboard.objects.create(team='marvel', points=135)
        Leaderboard.objects.create(team='dc', points=285)
